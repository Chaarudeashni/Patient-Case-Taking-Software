...
class ReviewOfSystemsCreateSchema(BaseModel):
    case_id: int
...
class ExtractedDataCreateSchema(BaseModel):
    document_id: int
...
class AISummaryCreateSchema(BaseModel):
    ...
    possible_assessment: str | None = None
...
class ConsultationCreateSchema(BaseModel):
    ...
    ai_summary_id: int | None = None
    consultation_date: datetime | None = None
    consultation_type: str | None = Field(default=None, max_length=50)
